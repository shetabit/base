...
! function(a, b) {
	...
	! function(a) {
		...
		e.VERSION = "1.10.0", e.DEFAULTS = {
			noneSelectedText: "هیچ ایتمی انتخاب نشده",
			noneResultsText: "نتیجه ای برای {0} پیدا نشد",
			countSelectedText: function(a, b) {
				return 1 == a ? "{0} ایتم انتخاب شده" : "{0} ایتم انتخاب شده"
			},
			maxOptionsText: function(a, b) {
				return [1 == a ? "فقط ({n} ایتم میتوانید انتخاب کنید)" : "فقط ({n} ایتم میتوانید انتخاب کنید)", 1 == b ? "Group limit reached ({n} item max)" : "Group limit reached ({n} items max)"]
			},
