...
!function($) {
    ...
    MorrisCharts.prototype.init = function() {
        ...
        this.createLineChart('morris-line-example', $data, 'y', ['a', 'b','c'], ['سری آ', 'سری ب', 'سری س'],['0.1'],['#ffffff'],['#999999'], ['#36404a', '#5fbeaa', '#5d9cec']);
        ...
        this.createAreaChart('morris-area-example', 0, 0, $areaData, 'y', ['a', 'b','c'], ['سری آ', 'سری ب', 'سری س'], ['#5fbeaa', '#5d9cec', '#bbbbbb']);
        ...
        this.createAreaChartDotted('morris-area-with-dotted', 0, 0, $areaDotData, 'y', ['a', 'b'], ['سری آ', 'سری ب'],['#ffffff'],['#999999'], ['#36404a', '#5d9cec']);
        ...
        this.createBarChart('morris-bar-example', $barData, 'y', ['a', 'b', 'c'], ['سری آ', 'سری ب', 'سری س'], ['#5fbeaa', '#5d9cec', '#ebeff2']);
        ...
        this.createStackedChart('morris-bar-stacked', $stckedData, 'y', ['a', 'b'], ['سری آ', 'سری ب'], ['#5d9cec', '#ebeff2']);

        //creating donut chart
        var $donutData = [
                {label: "فروش دانلودی", value: 12},
                {label: "فروش در فروشگاه", value: 30},
                {label: "سفارش ایمیلی", value: 20}
            ];
