...
!function($) {
    ...
    DashboardCRM.prototype.init = function() {
        ...
        this.createLineChart('morris-line-chart', $data, 'y', ['a', 'b'], ['معامله موفق', 'معامله ناموفق '],['0.1'],['#ffffff'],['#999999'], ['#81c868', '#ffbd4a']);
        ...
        this.createBarChart('morris-bar-chart', $barData, 'y', ['a', 'b'], ['معامله موفق', 'معامله ناموفق '], ['#5fbeaa', '#5d9cec']);
        
        //creating donut chart
        var $donutData = [
                {label: "گروه 1", value: 12},
                {label: "گروه 2", value: 30},
                {label: "گروه 3", value: 20}
            ];
